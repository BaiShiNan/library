...
<template>
  ...
  >
    ...
    <div class="p-4 flex flex-col flex-grow">
      <h3
        class="font-bold text-gray-800 text-lg mb-1 line-clamp-2 leading-tight group-hover:text-primary transition-colors"
        :title="book.title"
      >
        {{ book.title }}
      </h3>
      ...
      <div
        class="mt-auto flex items-center justify-between pt-3 border-t border-gray-50"
      >
