...
<template>
  <div class="flex flex-col lg:flex-row gap-8">
    ...
    <aside class="w-full lg:w-72 flex-shrink-0 space-y-8">
      <!-- Categories -->
      <div
        class="bg-white rounded-2xl shadow-card border border-gray-100 p-6 sticky top-24 transition-all duration-300"
      >
    ...
    <div class="flex-grow min-w-0">
      <!-- Header -->
      <div
        class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8 flex flex-col sm:flex-row justify-between items-center gap-4"
      >
        <div>
