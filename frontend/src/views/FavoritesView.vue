  ...
  <div class="max-w-6xl mx-auto">
    ...
    >
      ...
      <p class="text-gray-500 mb-8 max-w-md mx-auto">
        遇到喜欢的书就收藏起来吧，方便以后快速找到。
      </p>
      <RouterLink
        to="/books"
        class="inline-flex items-center px-6 py-3 bg-primary text-white rounded-full hover:bg-blue-800 transition shadow-md hover:shadow-lg font-medium"
      >
