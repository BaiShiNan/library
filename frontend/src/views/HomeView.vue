...
<template>
  <div class="space-y-16">
    <!-- Hero Section -->
    <section
      class="relative bg-gradient-to-br from-primary to-blue-900 rounded-3xl p-8 md:p-16 text-white overflow-hidden shadow-2xl"
    >
      <!-- Background pattern -->
      <div
      ...
      ></div>
      <div
        class="absolute -bottom-24 -right-24 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"
      ></div>
      ...
      <div class="relative z-10 max-w-3xl mx-auto text-center space-y-8">
        ...
        <p
          class="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto font-light"
        >
        ...
        <div class="relative max-w-2xl mx-auto group">
          <div
            class="absolute -inset-1 bg-gradient-to-r from-blue-400 to-accent rounded-full blur opacity-25 group-hover:opacity-50 transition duration-200"
          ></div>
    ...
    <section class="container mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        >
          ...
          ></div>
          <div
            class="w-12 h-12 mx-auto bg-blue-50 text-primary rounded-full flex items-center justify-center mb-4 group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-300"
          >
            <BookOpen class="h-6 w-6" />
          </div>
          <h3
            class="font-bold text-gray-700 group-hover:text-primary transition-colors text-lg"
          >
            {{ category.name }}
          </h3>
        </RouterLink>
    ...
    <section class="container mx-auto">
      <div class="flex justify-between items-center mb-8">
        ...
        <RouterLink
          to="/books"
          class="flex items-center text-primary hover:text-blue-700 font-medium group transition-colors px-4 py-2 rounded-full hover:bg-blue-50"
        >
          查看全部
          <ChevronRight
      ...
      >
        <div
          v-for="i in 4"
          :key="i"
          class="bg-white aspect-[3/4] rounded-xl animate-pulse bg-gray-200"
        ></div>
      </div>
